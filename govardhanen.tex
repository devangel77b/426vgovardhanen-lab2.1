...
% set PDF metadata
\hypersetup{%
pdftitle={Newton's second law as demonstrated ina cart-pulley-mass system},
pdfauthor={Vasudevan Govardhanen, Gage Grant, Aidan Dumalagan, Tushaar Akula, Daivik Jajoo, Rohan Avalur, Adrit Sikdar, and Jake Cacciarelli},
}
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancyhf{}
\fancyhead[RE,RO]{J S\&E \textbf{1}, 15--16 (2024)}
\fancyhead[LO]{Govardhanen et al.}
\fancyhead[LE]{Newton's second law as demonstrated}
\fancyfoot[C]{\thepage}
\fancypagestyle{mytitlepage}{
\fancyhf{}
\fancyhead[C]{Journal of Science \& Engineering \textbf{1}, 15--16 (2024)}
\fancyfoot[C]{\thepage}
}
